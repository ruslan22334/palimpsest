...
(async()=>{
  ...
  const shipped=new Set(['assets','docs','node_modules','spellcraft.js','knowledge.js','core.js','combat-rules.js','simulation.js','renderer.js','game.js','index.html','style.css','main.cjs','package.json','README.md','THIRD-PARTY-NOTICES.md']);
