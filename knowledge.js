(function(root, factory) {
  ...
  fact('mage:cost','earth','effect','Вражеский маг тратит ману на заклинания. Когда сосуд пуст, ему нужен подходящий источник мира.');
  fact('mage:interrupt','air','effect','Попадание сбивает подготовку вражеского мага. Его светящаяся линия показывает выбранное направление.');
  const self = {
