(function(root, factory) {
  ...
  const MAX_ASPECTS = 5;
  const REACTIONS = {
    barrier: {pair:['earth','air'],name:'Земляной заслон',color:'#c3ac80',text:'Земля → воздух: поднимает стену на свободной земле. Огонь обжигает её, вода размягчает, удары и давление разрушают. Искра тоже разбирает стены.'},
