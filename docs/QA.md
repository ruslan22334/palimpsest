...
## Восьмой этап: версия 1.7.0

Проходит 121 автоматическая проверка. Семнадцать новых покрывают стоимость нескольких сосудов, атомарный отказ, общую формулу инея, уклонение от зафиксированной цели, прерывание, щиты, кольца, стены, авторство огня, сбор и вместимость, поиск доступного источника и его тушение, истощение экологией, миграцию и отсутствие бесплатного пополнения после гибели игрока.

При 1280×720 через обычный интерфейс проверены роль, полоска маны, численная подсказка, линия подготовки, попадания и расход щита игрока. Угольный маг с пустым сосудом подошёл к огню и начал собирать ману. Водяная печать с протяжением погасила источник и сбивала подготовку попаданиями. На отдельном более живучем тестовом противнике подтверждено состояние «Источник недоступен», 0/60 огня и прекращение атак; после паузы и перезапуска нулевой запас и погашенный источник сохранились. Подсказка ограничена шириной окна. Ошибок консоли нет, тестовое путешествие и размер окна восстановлены.

![Маг после потери источника](screenshots/mage-source-denied.png)

Windows-сборка 1.7.0 прошла запуск в отдельном профиле: packaged=true, ошибок renderer нет, код выхода 0.

Независимое полное прохождение кампании с магами и баланс сложных групповых боёв пока не выполнены.
